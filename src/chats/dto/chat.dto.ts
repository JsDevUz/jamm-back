...
export class RegisterE2EPublicKeyDto {
  /**
   * Base64-encoded SPKI public key (ECDH P-256, generated by SubtleCrypto).
   * Minimum 88 chars (raw P-256 SPKI is 91 bytes → 124 base64 chars).
   */
  @IsString()
  @Length(88, 512)
  publicKey: string;
